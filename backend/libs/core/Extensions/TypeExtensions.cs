...
namespace CoEvent.Core.Extensions
{
  ...
  public static class TypeExtensions
  {
    ...
    /// </summary>
    private static readonly ConcurrentDictionary<Type, IEnumerable<PropertyInfo>> _typeCache = new();
    private static readonly ConcurrentDictionary<Type, IEnumerable<ConstructorInfo>> _typeConstructorCache = new();
    #endregion
    ...
    /// <summary>
    /// Get the properties for the specified type and cache them in memory.
    ...
    /// <summary>
    /// Get the constructors for the specified type and cache them in memory.
    /// This method is only useful for instance type objects.
    /// </summary>
    /// <param name="type"></param>
    /// <param name="bindingFlags"></param>
