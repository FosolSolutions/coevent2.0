...
public static class DbContextExtensions
{
  ...
  /// <param name="entity"></param>
  /// <returns></returns>
  public static IEnumerable<Cache> UpdateCache<T>(this CoEventContext context, T entity)
      where T : notnull
  {
  ...
  /// <param name="entity"></param>
  /// <returns></returns>
  public static IEnumerable<Cache> UpdateCache<T>(this CoEventContext context)
      where T : notnull
  {
  ...
  /// <returns></returns>
  public static IEnumerable<Cache> UpdateCache(this CoEventContext context, Type type)
  {
  ...
  /// <returns></returns>
  public static Cache? UpdateCache(this CoEventContext context, string key)
  {
    // Update Cache
